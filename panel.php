    ...
    if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true){ ?>
        ...
        <body class="sb-nav-fixed">
            <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
                ...
                <!-- Navbar Search-->
                <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" action="panel.php">
                    <div class="input-group">
                        <button class="btn btn-primary" id="btnNavbarSearch" type="submit">Cerrar sesión</button>
                    </div>
                </form>
                <!-- Navbar-->
            </nav>
